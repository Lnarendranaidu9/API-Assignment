...
URL with missing API key in query param       ${base_url}           /query?function=TIME_SERIES_DAILY&symbol=IBM&apikey=                              200
...
Validate API
    ...
    run keyword if  '${statusCode}'=='200'   Should Contain Any  ${response.json()}  Error Message  apikey
